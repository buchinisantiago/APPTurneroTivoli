...
CREATE INDEX IF NOT EXISTS idx_stock_products_shop ON stock_products(shop_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_stock_entry_unique ON stock_entries(stock_product_id, entry_date);
