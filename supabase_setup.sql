-- ============================================
-- APP-RRHH Schedule — Supabase (PostgreSQL) Setup
-- ============================================
...
CREATE TABLE IF NOT EXISTS stock_entries (
  ...
  notes TEXT NULL,
  created_at TIMESTAMP WITH TIME ZONE NULL DEFAULT CURRENT_TIMESTAMP,
  CONSTRAINT stock_entries_shop_id_fkey FOREIGN KEY (shop_id) REFERENCES shops(id) ON DELETE CASCADE,
  CONSTRAINT stock_entries_stock_product_id_fkey FOREIGN KEY (stock_product_id) REFERENCES stock_products(id) ON DELETE CASCADE,
  CONSTRAINT stock_entries_recorded_by_fkey FOREIGN KEY (recorded_by) REFERENCES users(id) ON DELETE SET NULL,
  CONSTRAINT stock_entries_unique UNIQUE (shop_id, stock_product_id, entry_date)
);
...
-- Staff accounts (password = username, e.g. staff1/staff1)
